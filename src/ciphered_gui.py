"""
@mainpage
@brief Welcome to the documentation of this lab about cryptography. The questions have been asked in French and will be answered in French, but the whole documentation is written in English, as were several docstrings in dependancies of this project.
